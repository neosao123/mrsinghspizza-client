              ...
              <div className="col-lg-12 pd0">
                <div className="special-offer-block ol_flr new-block">
                  <div className="ol_flr">
                    <div
                      className="nav btn-filter-wrap mb-3"
                      style={{
                        height: "2rem",
                        width: "830px",
                      }}
                    >
                      {/* Tabs */}
                      <ul
                        className="nav nav-tabs mt-2 d-flex justify-content-between mb-3"
                        role="tablist"
                      >
                        <li className="nav-item">
                          <button
                            ...
                            data-bs-toggle="tab"
                            className="filterer nav-link active btn"
                        ...
                        <li className="nav-item">
                          <button
                            className="filterer nav-link btn"
                            id="special-tab"
                            data-bs-toggle="tab"
